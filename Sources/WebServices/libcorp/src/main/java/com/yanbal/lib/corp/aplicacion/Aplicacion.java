...
/**
 * Clase encargada de leer las configuraciones e inicializar los objetos (técnicos y de negocio que
 * definen el comportamiento de la aplicación)
 * 
 * @author jcabrera
 *
 */
public abstract class Aplicacion {
  ...
  /**
   * Debe instanciar todos los objetos según su configuración e inyectarlos en el contexto de
   * apliación o cargar un factory Llenar los objetos de datos de la aplicacion
   */
