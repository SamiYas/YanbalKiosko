...
var wp8PlatformsDir = path.resolve(__dirname, '../../platforms/wp8/www/lib/ionic/scss');
var androidComponents = path.resolve(__dirname, '../../platforms/android/assets/www/components');

deleteFolderRecursive(iosPlatformsDir);
deleteFolderRecursive(androidPlatformsDir);
deleteFolderRecursive(wp8PlatformsDir);
deleteFolderRecursive(androidComponents);
