        ...
        return {
            ...
            link: function (scope, element, attrs, ngModel) {
                ...
                var searchContainerTemplate = [
                    ...
                    '<ion-item collection-repeat="item in items" item-height="38" item-width="100%" type="item-text-wrap" ng-click="selectItem(item)">',
                ...
                $ionicTemplateLoader.compile({
                    ...
                    scope: scope,
                    appendTo: document.getElementsByClassName('yanbalCountry')[0]
